...
function Register() {
	...
	const [useCep, setUseCep] = React.useState();
	const check = async (e) => {
						...
						<Box alignContent="center" m="0 auto" mt="32px" width="410px">
							...
							<Flex>
								...
								<FormControl mt="16px" isInvalid={!!formik.errors.state}>
									...
									<Input
										...
										name="state"
										onChange={formik.handleChange}
										// value={formik.values.state || useCep?.uf}
							...
							<Flex>
								...
								>
									...
									<Input
										...
										name="city"
										onChange={formik.handleChange}
										// value={formik.values.city || useCep?.localidade}
								...
								<FormControl mt="16px" isInvalid={!!formik.errors.district}>
									...
									<Input
										...
										name="district"
										onChange={formik.handleChange}
										// value={formik.values.district || useCep?.bairro}
							...
							<FormControl mt="16px" isInvalid={!!formik.errors.street}>
								...
								<Input
									...
									name="street"
									onChange={formik.handleChange}
									// value={formik.values.street || useCep?.logradouro}
